...
function Test() {
  return (
    <div id='test' className='flex h-screen flex-col justify-center items-center gap-2 p-4 md:p-8 lg:p-16'>
      ...
      <h2 className='w-full md:w-2/3 lg:w-1/2 text-base md:text-lg lg:text-xl font-light text-center my-4'>"We won't share your answers with anyone and won't even tell you which friends said what about you."</h2>
